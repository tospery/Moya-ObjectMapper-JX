...
if [[ "$CONFIGURATION" == "Debug" ]]; then
  ...
  install_framework "${BUILT_PRODUCTS_DIR}/Moya.default-RxSwift/Moya.framework"
  install_framework "${BUILT_PRODUCTS_DIR}/Moya-ObjectMapper-JX.default-RxSwift/Moya_ObjectMapper_JX.framework"
